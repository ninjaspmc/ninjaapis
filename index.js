...
app.get('/canvas/boasvindas', async (req, res) => {
  try {
    ...
    let welcomer = await new canvasx.Welcome()
      ...
      .setAvatar(perfil)
      .setBackground(fundo)
      .setColor('border', cor_borda.replace("#", "%23"))
      .setColor('username-box', cor_caixa_username.replace("#", "%23"))
      .setColor('discriminator-box', cor_caixa_discriminador.replace("#", "%23"))
      .setColor('message-box', cor_caixa_mensagem.replace("#", "%23"))
      .setColor('username', cor_username.replace("#", "%23"))
      .setColor('discriminator', cor_discriminador.replace("#", "%23"))
      .setColor('title', cor_titulo.replace("#", "%23"))
      .setColor('message', cor_mensagem.replace("#", "%23"))
      .setColor('member-count', cor_contador.replace("#", "%23"))
      .setColor('avatar', cor_perfil.replace("#", "%23"))
      .setColor('hashtag', cor_hashtag.replace("#", "%23"))
      .toAttachment();

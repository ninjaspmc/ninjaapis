...
app.get('/canvas/boasvindas', async (req, res) => {
  try {
    ...
    let welcomer = await new canvasx.Welcome()
      ...
      .setAvatar(perfil)
      .setBackground(fundo)
      .setColor('border', encodeURIComponent(cor_borda))
      .setColor('username-box', encodeURIComponent(cor_caixa_username))
      .setColor('discriminator-box', encodeURIComponent(cor_caixa_discriminador))
      .setColor('message-box', encodeURIComponent(cor_caixa_mensagem))
      .setColor('username', encodeURIComponent(cor_username))
      .setColor('discriminator', encodeURIComponent(cor_discriminador))
      .setColor('title', encodeURIComponent(cor_titulo))
      .setColor('message', encodeURIComponent(cor_mensagem))
      .setColor('member-count', encodeURIComponent(cor_contador))
      .setColor('avatar', encodeURIComponent(cor_perfil))
      .setColor('hashtag', encodeURIComponent(cor_hashtag))
      .toAttachment();

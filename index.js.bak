...
app.get('/canvas/boasvindas', async (req, res, next) => {
var { username, discriminador, titulo, mensagem, contador, perfil, fundo, cor_borda, cor_caixa_username, cor_caixa_discriminador, cor_caixa_mensagem, cor_username, cor_discriminador, cor_titulo, cor_mensagem, cor_contador, cor_perfil, cor_hashtag } = req.query
if (!username) return res.json({ status: 404, error: 'Insira o parametro: username'})
if (!discriminador) return res.json({ status: 404, error: 'Insira o parametro: discriminador'})
if (!titulo) return res.json({ status: 404, error: 'Insira o parametro: titulo'})
if (!mensagem) return res.json({ status: 404, error: 'Insira o parametro: mensagem'})
if (!contador) return res.json({ status: 404, error: 'Insira o parametro: contador'})
if (!perfil) return res.json({ status: 404, error: 'Insira o parametro: perfil'})
if (!fundo) return res.json({ status: 404, error: 'Insira o parametro: fundo'})
if (!cor_borda) return res.json({ status: 404, error: 'Insira o parametro: cor_borda'})
if (!cor_caixa_username) return res.json({ status: 404, error: 'Insira o parametro: cor_caixa_username'})
if (!cor_caixa_discriminador) return res.json({ status: 404, error: 'Insira o parametro: cor_caixa_discriminador'})
if (!cor_caixa_mensagem) return res.json({ status: 404, error: 'Insira o parametro: cor_caixa_mensagem'})
if (!cor_username) return res.json({ status: 404, error: 'Insira o parametro: cor_username'})
if (!cor_discriminador) return res.json({ status: 404, error: 'Insira o parametro: cor_discriminador'})
if (!cor_titulo) return res.json({ status: 404, error: 'Insira o parametro: cor_titulo'})
if (!cor_mensagem) return res.json({ status: 404, error: 'Insira o parametro: cor_mensagem'})
if (!cor_contador) return res.json({ status: 404, error: 'Insira o parametro: cor_contador'})
if (!cor_perfil) return res.json({ status: 404, error: 'Insira o parametro: cor_perfil'})
if (!cor_hashtag) return res.json({ status: 404, error: 'Insira o parametro: cor_hashtag'})
...
require('fs').writeFileSync(bla + '/assets/Tempo/welkom.png', base64, 'base64')

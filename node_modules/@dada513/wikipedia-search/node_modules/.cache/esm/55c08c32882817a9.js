let http,htmlToText;_882‍.x([["search",()=>search]]);_882‍.w("axios",[["default",["http"],function(v){http=v}]]);_882‍.w("html-to-text",[["default",["htmlToText"],function(v){htmlToText=v}]]);
 ...
 * app();
 */
       const search = async (keyword, language) => {

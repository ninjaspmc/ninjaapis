...
const { axios, cheerio, encodeUrl, fs, linkfy, qs, randomIntFromInterval, removerAcentos, useragent_1, default_criador } = require('./defaults.js');
...
axios.get(`https://www.dicio.com.br/${q.toLowerCase()}/`, {
      headers: {
        ...useragent_1
      }
   }).then((res) => {
